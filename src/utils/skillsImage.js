...
import RestApi from '../assets/svg/skills/rest-api-icon.svg'
import canva from '../assets/svg/skills/canva.svg'

import express from '../assets/svg/skills/express-js-icon.svg'
import redux from '../assets/svg/skills/redux-icon.svg'
import socket from '../assets/svg/skills/socket-io-icon.svg'
import hook from '../assets/svg/skills/crane-hook-icon.svg'
import postman from '../assets/svg/skills/postman-icon.svg'
import mongoose from '../assets/svg/skills/mongoose-icon.svg'
import nodejs from '../assets/svg/skills/node-js-icon.svg'
